...
attribute_string = input("Please enter the attribute string (e.g., SIED2CTRL/XCBR1.Pos.Oper.ctlVal[CO] from last output): ")

# Prompt the user for an IP address
ip_address = input("Please enter the IP address: ")

# Construct the command with the user's inputs
command = ['.\iec61850_actions.exe', 'get', 'value', attribute_string, ip_address]
...
if confirm.lower() in ['yes', 'y']:  # Accept both 'yes' and 'y' as affirmative responses
    ...
    if result.returncode == 0:
        ...
        print("mms_AttributeValues_Output:", result.stdout)
